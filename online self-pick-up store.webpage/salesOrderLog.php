...
<body>
        ...
        <div class="container">
                <div class="sidebar">
                    ...
                    <div class="sidebar-content" style="margin-top: 15%; height: 95%;">
                        ...
                        <button><a href="managerSalesOrderLog.php?id=<?php echo $id; ?>"> Manager view Product Consumption Record</a></button> 
                    </div>
                </div>
                <?php
                include "conn.php";
                ...
                <form id="storeForm" target="responseFrame" method="POST" action="fetch_store_log_details.php">
                    <div class="store-select">
                        ...
                        echo '<select id="storeSelect" name="sid" title="Select a store" onchange="document.getElementById(\'storeForm\').submit()">
                            ...
                            $sql = "SELECT * FROM employee JOIN store USING (sid) WHERE id = $id";
    ...
    <!-- The hidden iframe is used to receive the response data -->
    <iframe id="responseFrame" name="responseFrame" style="display: none;" onload="processResponse(this)"></iframe>
    <script>
            // Process the return data of the iframe
            function processResponse(iframe) {
                const doc = iframe.contentDocument || iframe.contentWindow.document;
                const response = doc.body.innerHTML;  // Get the iframe content
                const data = JSON.parse(response);  // Parsing JSON
                updateContent(data); 
            }
            ...
            function updateContent(data) {
                ...
                // Displays the table and fills in the order data
                        ...
                        <td>
                            ${
                                row.pickup_time !== "0000-00-00 00:00:00"
                                    ...
                                    : `
                                    <form action="update_pickupTime.php" method="POST">
