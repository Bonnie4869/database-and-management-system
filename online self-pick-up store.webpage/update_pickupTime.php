            ...
            <div class="container">
                ...
                <div class="content">
                    ...
                    <?php
                        ...
                        if(mysqli_query($conn, $sql)) echo "Thank you!<br> You have successfully confirmed customer <b>" . $b_name ."'s</b> order <b>" . $oid ."</b> at time <b>" . $currentTime . "</b> .\n";
                        echo "<button type='btn'><a href='salesOrderLog.php?id=$id'>Back to OrderLog Page(for seller)</a></button></td>";
